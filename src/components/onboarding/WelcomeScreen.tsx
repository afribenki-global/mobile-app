    ...
    <div className="h-screen bg-gradient-to-b from-primary via-primary to-accent flex flex-col relative overflow-hidden">
      ...
      >
        <Button
          ...
          className="w-full h-12 bg-white text-primary hover:bg-white/90 rounded-xl"
        >
          {t('getStarted')}
        </Button>
        <Button
          ...
          variant="outline"
          className="w-full h-12 border-2 border-white text-white hover:bg-white/10 rounded-xl"
        >
          {t('signIn')}
        </Button>
      </motion.div>
