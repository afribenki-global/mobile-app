...
import { ArrowUpRight, ArrowDownRight, PiggyBank, TrendingUp, Users, Eye, EyeOff, Sparkles } from 'lucide-react';
...
export function HomeScreen() {
  ...
  const quickActions = [
    ...
    { id: 'ai-advice', icon: Sparkles, label: 'AI Advice', color: 'bg-warning', screen: 'explore' },
  ];
      ...
      >
        ...
        <Card className="bg-gradient-to-br from-primary to-accent p-6 text-white border-0 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={() => setCurrentScreen('wallet-send')}
            ...
            <button
              onClick={() => setCurrentScreen('wallet-receive')}
              className="bg-white/20 backdrop-blur-sm py-3 rounded-xl hover:bg-white/30 transition-colors"
            >
              <div className="flex items-center justify-center gap-2">
