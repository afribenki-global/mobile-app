...
import { ArrowLeft, TrendingUp, Shield, Info, DollarSign } from 'lucide-react';
...
export function FundDetails() {
  const { setCurrentScreen, formatCurrency } = useApp();
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SuccessModal
        ...
        message={`You've successfully invested ${formatCurrency(parseFloat(investAmount) || 0)} in ${fundInfo.name}`}
        action={{
